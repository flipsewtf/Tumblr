...
This is a thorough theme guide for my Tumblr theme **Bruise**.
...
This is a responsive Tumblr theme, with a sticky navbar and a slide-in sidebar. Optional dark mode, search bar, featured tags, and update tab included. Full support of NPF posts.

Options like custom post width, font size and font-families, photoset gutter, post information, tag display, sidebar image size and shape, and custom navigation labels. Optional featured tags and update tab sections, as well as choices between sharp or rounded corners.
...
All my themes are responsive, so depending on your screen size, the customization window might take up a lot of the space resulting in the theme to look different. Also, the Tumblr preview window rarely displays the exact product, so before messaging me please do the following:
...
5. Click **Edit HTML**, delete all existing code, then paste in Bruise's code.
...
Choose between `1.1rem` (11px) to `1.8rem` (18px).
...
**Icons** has just icons across the board.

**Text** has just text across the board.

**Both** has both icons and text across the board.
...
**Display** shows the tags as normal.

**Truncated** displays the first 3 tags, with a **see all** link to reveal the remaining tags.

**Behind Toggle** hides the tags until the tag toggle is clicked.
...
This controls the size of the sidebar image.
...
Here you can toggle on/off a variety of options. You can interact with the toggles in this guide.
...
This concerns the content boxes of the theme. Toggled off you will have square sharp corners. Toggled on, rounded soft corners.

---

## Rounded Photoset Corners

This concerns the photo(sets) of the theme. Toggled off you will have square sharp corners. Toggled on, rounded soft corners.
...
Toggle this on to have tagged pages displayed separately from your regular navigation as a highlighted Featured Tags section. Learn in detail how this works under **Text fields: Navigation**.

---

## Update Tab

The Update Tab is positioned in the slide-in sidebar. To change the icons, see how to under **Change icons**.

---

# Text fields: Customization

The following are text fields where you type text to change things or delete text to hide it.

---

## Body Font

You can freely decide on a Google Font of your choice for your blog. Go to `fonts.google.com` and copy the name of the font you want into the text field.
...
The accent font concerns a variety of different text like the tooltips, search bar, navigation, and post info.
...
The post margin is the gap between posts. Please keep a number in this. If you don't want any gap, write `0rem`.
...
The title in the sidebar, which is optional.
...
The description text is optional. It can contain HTML like links, bold, underline, or italic.
...
The label for the link to your blog's home page.
...
The label for the dropdown containing your Tumblr pages.
...
The label for the Featured Tags dropdown.
...
The label for your archive link.
...
The label for your Submit link.
...
The **Activity [#]** fields can contain HTML like links, etc. You can learn about changing the icons under **Change icons**.

The Update Tab is positioned in the slide-in sidebar.
...
| Activity 1 Icon | `tv`          |
| Activity 1      | `watching`    |
| Activity 2 Icon | `music`       |
| Activity 2      | `listening`   |
| Activity 3 Icon | `library-big` |
| Activity 3      | `reading`     |
| Activity 4 Icon | `dices`       |
| Activity 4      | `playing`     |
...
You're able to change the 4 activity icons in the Update Tab. For this theme, I'm utilizing **Lucide**.
