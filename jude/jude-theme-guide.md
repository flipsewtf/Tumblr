...
Bruise is a responsive theme, so depending on your screen size, the customization window might take up a lot of the space resulting in the theme to look different. Also, the Tumblr preview window rarely displays the exact product, so before messaging me please do the following:
...
| Truncated | displays the first 3, a **see all** link to reveal remaining. |
| Behind Toggle | both icons and text |
...
Default: `This is where your description text goes. Links and html is allowed.`
...
| Navigation Link Label | `Navigate`      | The label for the dropdown containing your Tumblr pages |
| Featured Link Label   | `Featured Tags` | The label for the Featured Tags dropdown                |
...
| **Text Field**  | **Default**   | **Description**         |
| --------------- | ------------- | ----------------------- |
| Activity 1 Icon | `tv`          | The icon for Activity 1 |
...
| Activity 3 Icon | `library-big` | The icon for Activity 3 |
| Activity 3      | `reading`     | The text for Activity 3 |
| Activity 4 Icon | `dices`       | The icon for Activity 4 |
